...
var init_config = __esm({
  "node_modules/@opennextjs/aws/dist/adapters/config/index.js"() {
    ...
    AppPathsManifestKeys = ["/api/assets/route", "/api/assets/[id]/route", "/api/assignments/route", "/api/departments/route", "/api/categories/route", "/api/employees/route", "/api/settings/route", "/api/sync/route", "/api/maintenance/route", "/assets/[id]", "/assets", "/assignments", "/maintenance", "/categories", "/settings", "/", "/_not-found"];
    MiddlewareManifest = { "version": 3, "middleware": {}, "functions": {}, "sortedMiddleware": [] };
    AppPathsManifest = { "/api/assets/route": "app/api/assets/route.js", "/api/assets/[id]/route": "app/api/assets/[id]/route.js", "/api/assignments/route": "app/api/assignments/route.js", "/api/departments/route": "app/api/departments/route.js", "/api/categories/route": "app/api/categories/route.js", "/api/employees/route": "app/api/employees/route.js", "/api/settings/route": "app/api/settings/route.js", "/api/sync/route": "app/api/sync/route.js", "/api/maintenance/route": "app/api/maintenance/route.js", "/assets/[id]/page": "app/assets/[id]/page.js", "/assets/page": "app/assets/page.js", "/assignments/page": "app/assignments/page.js", "/maintenance/page": "app/maintenance/page.js", "/categories/page": "app/categories/page.js", "/settings/page": "app/settings/page.js", "/page": "app/page.js", "/_not-found/page": "app/_not-found/page.js" };
    AppPathRoutesManifest = { "/api/assets/route": "/api/assets", "/api/assets/[id]/route": "/api/assets/[id]", "/api/assignments/route": "/api/assignments", "/api/departments/route": "/api/departments", "/api/categories/route": "/api/categories", "/api/employees/route": "/api/employees", "/api/settings/route": "/api/settings", "/api/sync/route": "/api/sync", "/api/maintenance/route": "/api/maintenance", "/assets/[id]/page": "/assets/[id]", "/assets/page": "/assets", "/assignments/page": "/assignments", "/maintenance/page": "/maintenance", "/categories/page": "/categories", "/settings/page": "/settings", "/page": "/", "/_not-found/page": "/_not-found" };
